...
Module {
    ...
    property string libFilePathRelease: "/home/can/Qt-android/5.4/android_armv5/lib/libQt5Core.so"
    property string libFilePath: qtBuildVariant === "debug"
                                      ? libFilePathDebug : libFilePathRelease

    coreLibPaths: ["/opt/android/ndk/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi", "/opt/android/ndk/platforms/android-9/arch-arm//usr/lib"]
    ...
    cpp.includePaths: {
        var paths = ["/home/can/Qt-android/5.4/android_armv5/include", "/home/can/Qt-android/5.4/android_armv5/include/QtCore"];
