...
Module {
    ...
    property string libFilePathRelease: "/home/can/Qt-android/5.4/android_x86/lib/libQt5Core.so"
    property string libFilePath: qtBuildVariant === "debug"
                                      ? libFilePathDebug : libFilePathRelease

    coreLibPaths: ["/opt/android/ndk/sources/cxx-stl/gnu-libstdc++/4.8/libs/x86", "/opt/android/ndk/platforms/android-9/arch-x86//usr/lib"]
    ...
    cpp.includePaths: {
        var paths = ["/home/can/Qt-android/5.4/android_x86/include", "/home/can/Qt-android/5.4/android_x86/include/QtCore"];
